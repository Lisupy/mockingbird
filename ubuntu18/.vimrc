set nocompatible
set backspace=2 " 解决insert模式无法删除问题
" **********vundle环境配置*******
filetype off
...
Plugin 'Lokaltog/vim-powerline'             " 底下状态栏插件
Plugin 'octol/vim-cpp-enhanced-highlight'   " C++11/14 语法高亮插件
Plugin 'nathanaelkane/vim-indent-guides'    " 对齐线插件 
Plugin 'derekwyatt/vim-fswitch'             " .h和.cpp文件之间的跳转
...
" 配色方案
set background=dark
colorscheme molokai "molokai solarized phd
" 开启行号
set number
" 开启语法高亮功能
syntax enable
